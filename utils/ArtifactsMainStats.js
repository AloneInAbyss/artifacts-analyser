...
const ArtifactsMainStats = {
  ...
  fourStar: {
    ...
    ATKFlat:   [42  , 54  , 66  , 78  , 90  , 102 , 113 , 125 , 137 , 149 , 161 , 173 , 185 , 197 , 209 , 221 , 232 ],
    HPPerc:    [6.3 , 8.1 , 9.9 , 11.6, 13.4, 15.2, 17.0, 18.8, 20.6, 22.3, 24.1, 25.9, 27.7, 29.5, 31.3, 33.0, 34.8],
    ATKPerc:   [6.3 , 8.1 , 9.9 , 11.6, 13.4, 15.2, 17.0, 18.8, 20.6, 22.3, 24.1, 25.9, 27.7, 29.5, 31.3, 33.0, 34.8],
    DEFPerc:   [7.9 , 10.1, 12.3, 14.6, 16.8, 19.0, 21.2, 23.5, 25.7, 27.9, 30.2, 32.4, 34.6, 36.8, 39.1, 41.3, 43.5],
    PhysDmg:   [7.9 , 10.1, 12.3, 14.6, 16.8, 19.0, 21.2, 23.5, 25.7, 27.9, 30.2, 32.4, 34.6, 36.8, 39.1, 41.3, 43.5],
    ElemDmg:   [6.3 , 8.1 , 9.9 , 11.6, 13.4, 15.2, 17.0, 18.8, 20.6, 22.3, 24.1, 25.9, 27.7, 29.5, 31.3, 33.0, 34.8],
  ...
  threeStar: {
    ...
    ATKFlat:   [28  , 36  , 44  , 52  , 60  , 68  , 76  , 84  , 91  , 99  , 107 , 115 , 123 ],
    HPPerc:    [5.2 , 6.7 , 8.2 , 9.7 , 11.2, 12.7, 14.2, 15.6, 17.1, 18.6, 20.1, 21.6, 23.1],
    ATKPerc:   [5.2 , 6.7 , 8.2 , 9.7 , 11.2, 12.7, 14.2, 15.6, 17.1, 18.6, 20.1, 21.6, 23.1],
    DEFPerc:   [6.6 , 8.4 , 10.3, 12.1, 14.0, 15.8, 17.7, 19.6, 21.4, 23.3, 25.1, 27.0, 28.8],
    PhysDmg:   [6.6 , 8.4 , 10.3, 12.1, 14.0, 15.8, 17.7, 19.6, 21.4, 23.3, 25.1, 27.0, 28.8],
    ElemDmg:   [5.2 , 6.7 , 8.2 , 9.7 , 11.2, 12.7, 14.2, 15.6, 17.1, 18.6, 20.1, 21.6, 23.1],
  ...
  twoStar: {
    ...
    ATKFlat:   [17  , 22  , 26  , 31  , 36  , 41  , 45  , 50  , 55  ],
    HPPerc:    [4.2 , 5.4 , 6.6 , 7.8 , 9.0 , 10.1, 11.3, 12.5, 13.7],
    ATKPerc:   [4.2 , 5.4 , 6.6 , 7.8 , 9.0 , 10.1, 11.3, 12.5, 13.7],
    DEFPerc:   [5.2 , 6.7 , 8.2 , 9.7 , 11.2, 12.7, 14.2, 15.6, 17.1],
    PhysDmg:   [5.2 , 6.7 , 8.2 , 9.7 , 11.2, 12.7, 14.2, 15.6, 17.1],
    ElemDmg:   [4.2 , 5.4 , 6.6 , 7.8 , 9.0 , 10.1, 11.3, 12.5, 13.7],
    EM:        [17  , 22  , 26  , 31  , 36  , 41  , 45  , 50  , 55  ],
    ER:        [4.7 , 6.0 , 7.3 , 8.6 , 9.9 , 11.3, 12.6, 13.9, 15.2],
  ...
  oneStar: {
    ...
    ATKFlat:   [8   , 12  , 15  , 18  , 21  ],
    HPPerc:    [3.1 , 4.3 , 5.5 , 6.7 , 7.9 ],
    ATKPerc:   [3.1 , 4.3 , 5.5 , 6.7 , 7.9 ],
    DEFPerc:   [3.9 , 5.4 , 6.9 , 8.4 , 9.9 ],
    PhysDmg:   [3.9 , 5.4 , 6.9 , 8.4 , 9.9 ],
    ElemDmg:   [3.1 , 4.3 , 5.5 , 6.7 , 7.9 ],
    EM:        [13  , 17  , 22  , 27  , 32  ],
